...
const LoginComponent = () => {
  ...
  if (!hasGoogleClientId) {
    // Required warning for fresh clones without .env
    console.warn("VITE_GOOGLE_CLIENT_ID is missing. Google Login disabled.");
  }
    ...
    <div className="min-h-screen bg-white dark:bg-[#0B1120] text-slate-900 dark:text-slate-100 flex items-center justify-center relative overflow-hidden p-4 sm:p-8 box-border overflow-x-hidden">
      ...
      <div className="flex w-full max-w-5xl flex-row justify-center gap-16 py-12 relative z-10 box-border items-center">
        ...
        <div className="hidden lg:flex flex-col gap-5 max-w-sm">
          ...
          {/* Informational cards */}
          <div className="flex flex-col justify-center gap-6 w-full max-w-md mx-auto box-border">
        ...
        <div className="w-full max-w-md bg-slate-50 dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl p-8 sm:p-10 shadow-2xl box-border overflow-hidden relative min-w-0">
          {/* Back to Home */}
          <button
